            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="bd-hero-text">
                        ...
                        <h2>There is Camping And More Events Per Week. And We Make Several Trips Per Week</h2>
                        <ul>
                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="blog-details-text">
                        <div class="bd-title">
                            ...
                            <p>
                                In Nepal your overseas adventure travel is going to be fascinating. You will get to see
                                ...
                                travel destination list for sure!
                            </p>
                        </div>
                        <div class="bd-pic">
                            <div class="bp-item">
                        ...
                        <div class="bd-more-text">
                            <div class="bm-item">
                                ...
                                <p>
                                    You know all about the traffic there. Getting places is often next to impossible,
                            ...
                            <div class="bm-item">
                                ...
                                <p>
                                    I hope I’ll be lucky enough to get one that’s halfway decent and that the driver
                                    ...
                                    much they cost by now, going with a limo makes ever more sense.
                                </p>
                            </div>
                        </div>
                        <div class="tag-share">
                        ...
                        <div class="comment-option">
                            ...
                            <div class="single-comment-item first-comment">
                                <div class="sc-author">
                                    <img src="img/nader.jpeg" alt="">
                                </div>
                                <div class="sc-text">
                                    <span>27 Aug 2019</span>
                                    <h5>Youssef Nader</h5>
                                    <p>
                                       I was very happy to stay there for excursions and go to premium places like diving .
                                    </p>
                            ...
                            <div class="single-comment-item reply-comment">
                                <div class="sc-author">
                                    <img src="img/bodaaaa.jpeg" alt="">
                                </div>
                                <div class="sc-text">
                                    <span>27 Aug 2019</span>
                                    <h5>Abd ElRhman Ibrahim</h5>
                                    <p>
                                        One of the best tourist villages that I went to, I will return to them soon .
                                    </p>
                            ...
                            <div class="single-comment-item second-comment ">
                                <div class="sc-author">
                                    <img src="img/wanaaa.jpeg" alt="">
                                </div>
                                <div class="sc-text">
                                    <span>27 Aug 2019</span>
                                    <h5>Rowan Mahmoud</h5>
                                    <p>
                                       I loved this resort so much, it contains all the features that anyone needs and
                                        many entertainment means such as cafes, shopping, markets ect .
                                    </p>
                                    <a href="#" class="comment-btn">Like</a>
                                    <a href="#" class="comment-btn">Reply</a>
                                </div>
                        ...
                        <div class="leave-comment">
                            ...
                            <form action="after-comment.aspx" class="comment-form">
                                <div class="row">
                                    <div class="col-lg-6">
