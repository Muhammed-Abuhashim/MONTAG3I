                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style6">Max persion 5</td>
                                    </tr>
                                    <tr>
                                        <td class="r-o">Bed:</td>
                                        <td class="auto-style6">King Beds &amp; (Single-Child) Bed</td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="ri-text">
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        <td class="r-o">Size:</td>
                                        <td class="auto-style5">65 ft</td>
                                    </tr>
                                    <tr>
                                        <td class="r-o">Capacity:</td>
                                        <td class="auto-style5">Max persion 4</td>
                                    </tr>
                                    <tr>
                                        <td class="r-o">Bed:</td>
                                        <td class="auto-style5">King Beds&nbsp; & Two Single Bed</td>
                                    </tr>
                                    <tr>
                                        <td class="r-o">Services:</td>
                        ...
                        <div class="ri-text">
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="r-o">Bed:</td>
                                        <td class="auto-style7">King Beds</td>
                                    </tr>
                                    <tr>
                                        <td class="r-o">Services:</td>
                        ...
                        <div class="ri-text">
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="r-o">Capacity:</td>
                                        <td class="auto-style1">Max persion 1</td>
                                    </tr>
                                    <tr>
                                        <td class="r-o">Bed:</td>
                                        <td class="auto-style1">Single Bed</td>
                                    </tr>
                                    <tr>
                                        <td class="r-o">Services:</td>
