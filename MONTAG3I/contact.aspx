<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="blog-details.aspx.cs" Inherits="MONTAG3I.blog_details" %>
<!DOCTYPE html>
...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <ul class="top-widget">
            <li><i class="fa fa-phone"></i> (+2) 01145406660</li>
        ...
        <div class="container">
            <div class="row">
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    ...
                                    <td class="auto-style1">288 Roushdy Street, Alexandria - Egypt</td>
                                </tr>
                                <tr>
                                    <td class="c-o">Phone:</td>
                                    <td class="auto-style1">(+2) 01145406660</td>                                   
                                </tr>
                                <tr>
                                    <td class="c-o">Phone:</td>
                                    <td class="auto-style1">(+2) 01202941341</td>                                   
                                </tr>
                                <tr>
                                    <td class="c-o">Phone:</td>
                                    <td class="auto-style1">(+2) 01280491414</td>                                   
                                </tr>
                                <tr>
                                    <td class="c-o">Phone:</td>
                                    <td class="auto-style1">(+2) 01124247841</td>                                   
                                </tr>
                                <tr>
                                    <td class="c-o">Email:</td>
                                    <td class="auto-style1">montag3i_2020@gmail.com</td>
                                </tr>
                                <tr>
                                    <td class="c-o">Fax:</td>
                                    <td class="auto-style1">+(12) 345 67890</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="col-lg-7 offset-lg-1">
                    <form action="after-comment.aspx" class="contact-form">
                        <div class="row">
                            <div class="col-lg-6">
            ...
            <div class="map">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13646.099806270435!2d29.937078532244676!3d31.233888103442904!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14f5c4e6861baba3%3A0x8038e261c5c73c23!2sStanli%20Beach!5e0!3m2!1sen!2seg!4v1590207674034!5m2!1sen!2seg" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
            </div>
        </div>
    </section>
    <!-- Contact Section End -->
